...
You can visit http://udacityproject.ddns.net/ for the website deployed.

## You may refer this Udacity course

1. https://www.udacity.com/course/configuring-linux-web-servers--ud299

## Create a new user named grader-1

1. `sudo adduser grader-1`
2. `sudo vi /etc/sudoers`
3. `sudo touch /etc/sudoers.d/grader-1`
4. `sudo vi /etc/sudoers.d/grader-1`, type in `grader ALL=(ALL:ALL) NOPASSWD:ALL`, save and quit
...
4. now you can use ssh to login with the new user you created
	...
	`ssh -i ~/.ssh/[privateKeyFilename] grader-1@117.204.34.172`
...
5. Clone the Catalog App to the virtual machine `git clone https://github.com/chandumelam123/Item-Catalog.git
